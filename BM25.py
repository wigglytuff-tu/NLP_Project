...
class SearchEngine:
	...
	def evaluateDataset(self):
		...
		for query in queries:
			...
			results.append(list(reversed(np.argsort(doc_scores))))

		# print(results[0])
		doc_IDs_ordered = results
...
# python main.py -dataset cranfield/ -out_folder output/ -segmenter punkt -tokenizer ptb
